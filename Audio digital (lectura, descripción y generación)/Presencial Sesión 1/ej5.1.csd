...
instr format
  ...
  iBytes =  iNChan*(iNBit/8)               ; calcula los bytes por muestra
  iFlujo =  ifs*iBytes               ; calcula el flujo
  iMuest =  iDura*(iFlujo/iBytes)              ; calcula el num. muestras en la sennal
