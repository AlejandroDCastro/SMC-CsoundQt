...
; Filtro Pasa Banda IIR de orden 1
opcode crucefc, 0,a
as xin
...
instr pasabajaIIR
  ...
  aout   init  0   ; crea e inicializa aout (necesario por la realimentacion)
...
;       p1       p2  p3     p4       p5
;  instrumento  ini dur   fichero  coef.a 
;-----------------------------------------
i "pasabajaIIR"  0  1  "f_6600.wav"  0.65
i "pasabajaIIR"  1  1  "f_var.wav"   0.90
i "pasabajaIIR"  2  1  "f_var.wav"   0.80
